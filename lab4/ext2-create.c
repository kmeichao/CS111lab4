...
void write_superblock(int fd)
{
	...
	superblock.s_inodes_per_group = NUM_INODES; // 1024<<s_log_block_size/s_inode_size
...
void write_block_bitmap(int fd)
{
	...
	block_bitmap = calloc(BLOCK_SIZE, sizeof(u8));
	block_bitmap[0] = 0xff;
	block_bitmap[1] = 0xff;
	block_bitmap[2] = 0x7f;
	block_bitmap[BLOCK_SIZE / 8 - 1] = 0b10000000;
...
void write_inode_bitmap(int fd)
{
	...
	inode_bitmap = calloc(BLOCK_SIZE, sizeof(u8));
	inode_bitmap[0] = 0xff;
	inode_bitmap[1] = 0x1f;
...
void write_inode_table(int fd)
{
	...
	hello_inode.i_block[0] = 0x6c6c6568; // hello world ascii
